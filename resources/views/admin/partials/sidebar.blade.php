{{-- <aside class="dashboard-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/products*') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            <li class="nav-item mb-2">
                <a class="nav-link text-white {{ Request::is('admin/dashboard') ? 'active bg-primary rounded px-3' : '' }}" href="#">
                    <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                </a>
            </li>
            <li class="nav-item mb-2">
                <a class="nav-link text-white {{ Request::is('admin/products*') ? 'active bg-primary rounded px-3' : '' }}" href="{{ route('admin.dashboard') }}">
